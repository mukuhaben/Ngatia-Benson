...
**Tech Stack:**  
`React (Vite)` · `Node.js` · `PostgreSQL` · `Render` · `Vercel`  

**Key Highlights:**
- Dynamic Tier-pricing for products and cashback logic  
...
- Taught computer basics and web development (HTML, CSS)  
- Contributed to design and deployment of institutional website  
...
- 🧾 Enumerator — *National Census (KNBS, 2019)*  
- 💳 Supervisor — *Huduma Number National ID Project (2019)*  
- 🏥 Enumerator — *ESR Welfare Improvement Project (GOK & World Bank, 2024)*  
- 💼 Supervisor — *SHA Health Access Data Management (2024)*  

---

## 📬 Contact Me

📧 Email: [254engineerben@gmail.com](mailto:254engineerben@gmail.com)  
📞 Phone: [+254 707 501 094](tel:+254707501094)  
🌐 GitHub: [@ngatiabenson](https://github.com/ngatiabenson) · [@mukuhaben](https://github.com/mukuhaben)
